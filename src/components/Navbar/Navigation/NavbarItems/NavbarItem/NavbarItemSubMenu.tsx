  ...
  return (
    <div
      className={combineClass(
        `absolute backdrop-blur-md bg-[#000000]/[85%] inset-0 top-0 mt-0 lg:mt-[53px] lg:py-28 lg:pt-10 z-[1] py-10 h-min lg:-z-10 transition-all duration-500 ease-in-out transform lg:-translate-y-20 -translate-x-[40%] lg:translate-x-0 opacity-0 pointer-events-none`,
        {
