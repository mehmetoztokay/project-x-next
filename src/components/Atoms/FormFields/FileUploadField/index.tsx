...
export const FileUploadField: React.FC<FileUploadFieldProps> = ({
  ...
  return (
    <div className="w-full overflow-hidden">
      <div
        className={combineClass("relative z-0 cursor-pointer select-none rounded-md border text-center text-gray-400 transition-colors", {
            ...
            <>
              <div className="flex w-full items-center gap-1 ltr:pr-7 rtl:pl-7">
                {preview ? (
                  ...
                  <div className="w-6">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" className="h-8 w-6 fill-gray-600">
                      <path d="M240-80q-33 0-56.5-23.5T160-160v-640q0-33 23.5-56.5T240-880h320l240 240v480q0 33-23.5 56.5T720-80H240Zm280-520v-200H240v640h480v-440H520ZM240-800v200-200 640-640Z" />
                    </svg>
                  </div>
                )}
                <p className="overflow-hidden text-ellipsis whitespace-nowrap text-gray-600">{file.name}</p>
              </div>
              <button
                type="button"
      ...
      {acceptTypesMessage && <p className="mt-1 px-1 text-xs text-gray-500">{acceptTypesMessage}</p>}
